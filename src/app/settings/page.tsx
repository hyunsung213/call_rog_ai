...
export default function MyPage() {
  return (
    <div className="flex-1 min-h-0 flex flex-col bg-gray-50 relative pb-14">
      <div className="bg-white z-10 sticky top-0 flex items-center justify-center shrink-0 relative h-12 overflow-hidden mt-1">
      ...
      <nav className="absolute bottom-0 w-full bg-white border-t border-gray-100 flex justify-around items-center py-2 pb-3 px-4 z-10">
        ...
        <Link href="/settings" className="flex items-center justify-center text-[#FF5A5F] p-2">
          <User size={24} />
        </Link>
      </nav>
    </div>
